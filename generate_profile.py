...
INFO = [
    ("__header__", "Akul Kamboj", ""),
    ("__rule__", "", ""),

    ("Role", "Aspiring Data Scientist / MERN Developer", "val"),
    ("Edu", "B.Tech CSE · Kurukshetra University · Class of 2028", "val"),
    ("Focus", "AI · MERN Stack · Data Science", "accent"),

    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),

    ("Core", "React.js · Next.js · JavaScript · TypeScript", "val"),
    ("Backend", "Node.js · Express.js · MongoDB · MySQL", "val"),
    ("Languages", "Python · Java · C++", "val"),
    ("Cloud", "Supabase · Firebase · Vercel", "val"),

    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),

    ("FoodieHub", "Full Stack Food Ordering Website", "warn"),
    ("Parkinson", "AI Disease Prediction System", "warn"),
    ("Portfolio", "Modern React Portfolio Website", "warn"),
    ("AI Chatbot", "Gemini AI Chat Application", "warn"),
    ("LMS", "Learning Management System", "warn"),

    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),

    ("GitHub", "github.com/kambojakul1-lgtm", "accent"),
    ("LinkedIn", "www.linkedin.com/in/akul-kamboj-b147b4250", "accent"),
    ("Mail", "kambojakul1@gmail.com", "accent"),
]
